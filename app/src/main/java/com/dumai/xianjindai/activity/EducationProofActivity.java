...
public class EducationProofActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        gridMaterial.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ("000000".equals(imgs)) {
                    PhotoPickerIntent intent = new PhotoPickerIntent(EducationProofActivity.this);
                    ...
                    PhotoPreviewIntent intent = new PhotoPreviewIntent(EducationProofActivity.this);
        ...
        gridAdapter = new GridMaterial(EducationProofActivity.this, imagePaths);
