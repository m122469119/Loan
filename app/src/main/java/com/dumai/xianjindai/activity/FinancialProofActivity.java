...
/**
 * 名称：FinancialProofActivity.java
 * 描述：财力证明
 *
 * @author haoruigang
 * @version v1.0
 ...
 */
public class FinancialProofActivity extends BaseActivity {
    ...
    protected int getContentViewId() {
        return R.layout.dm_activity_financial_proof;
    }

    @Override
    protected void initToolbar(ToolbarHelper toolbarHelper) {
        toolbarHelper.setTitle("财力证明");
    ...
    protected void init() {
        ...
        gridMaterial.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ("000000".equals(imgs)) {
                    PhotoPickerIntent intent = new PhotoPickerIntent(FinancialProofActivity.this);
                    ...
                    PhotoPreviewIntent intent = new PhotoPreviewIntent(FinancialProofActivity.this);
        ...
        gridAdapter = new GridMaterial(FinancialProofActivity.this, imagePaths);
