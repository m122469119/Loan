...
import com.dumai.xianjindai.view.app.AbMonitorView;
...
public final class MonitorUtil {
	...
	public static void openMonitor(Context context){
         ...
         */
        // 设置悬浮窗的长得宽
		mMonitorParams.width = ViewUtil.scaleValue(context, 100);
		mMonitorParams.height = ViewUtil.scaleValue(context, 50);
