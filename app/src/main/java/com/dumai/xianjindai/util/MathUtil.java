...
import com.dumai.xianjindai.model.Circle;
import com.dumai.xianjindai.model.Point;
...
public class MathUtil {
   ...
   */
	 ...
	 * @return
	 */
    public static boolean pointOnCircle(Point point, Circle c1, Circle c2){
    ...
    /**
 	 ...
 	 * @return
 	 */
     public static boolean pointOnCircle(Point point, Circle c1, Circle c2, float offset){
	 ...
	 * @return
	 */
	public static List<Point> circleCrossoverPoint(Circle circle1, Circle circle2){
		...
		Point p1_1 = new Point(x_1,y_1_1);
		if(pointOnCircle(p1_1,circle1,circle2)){
			pointSet.add(p1_1);
		}
		
		Point p1_2 = new Point(x_1,y_1_2);
		...
		Point p2_1 = new Point(x_2,y_2_1);
		if(pointOnCircle(p2_1,circle1,circle2)){
			pointSet.add(p2_1);
		}
		
		Point p2_2 = new Point(x_2,y_2_2);
		if(pointOnCircle(p2_2,circle1,circle2)){
			pointSet.add(p2_2);
		}
		for(Iterator<Point> iter = pointSet.iterator(); iter.hasNext();){
