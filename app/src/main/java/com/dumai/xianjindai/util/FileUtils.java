...
public class FileUtils {
    ...
    public static Bitmap getBitmapFromURL(String url, int desiredWidth, int desiredHeight) {
        Bitmap bitmap = null;
        try {
            bitmap = ImageUtils.getBitmap(url, desiredWidth, desiredHeight);
        } catch (Exception e) {
            LogUtil.d(FileUtils.class, "下载图片异常：" + e.getMessage());
        }
        return bitmap;
    }
    ...
    public static Bitmap getBitmapFromSrc(String src) {
        ...
        try {
            ...
            LogUtil.d(FileUtils.class, "获取图片异常：" + e.getMessage());
        }
        return bit;
    }
    ...
    public static String downloadFile(String url, String dirPath) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.e(FileUtils.class, "有文件下载出错了,已删除");
    ...
    public static int getContentLengthFromUrl(String Url) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.d(FileUtils.class, "获取长度异常：" + e.getMessage());
        }
    ...
    public static String getRealFileNameFromUrl(String url) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.e(FileUtils.class, "网络上获取文件名失败");
        }
        return name;
    }
