...
/**
 * 名称：InfoCreditFragment.java
 * 描述：信用认证信息
 *
 * @author haoruigang
 * @version v1.0
 * @date： 2017-11-23 10:47:32
 */
public final class InfoCreditFragment extends BaseFragment {
    ...
    public void onUpdateUI() {
        ...
        frgBg.setBackground(getResources().getDrawable(R.drawable.phone_3));
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.submit_btn_info:
                ...
                startActivity(new Intent(getActivity(), InfoCreditActivity.class).putExtras(bundle));
                break;
        }
    }
}
